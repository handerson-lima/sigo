...
|---|---|---|---|---|---|---|
| D1 | desenvolvedor global mantido, sem exigir vínculo por obra | aprovado-2026-09-15 | administração global preservada com concessão protegida; identidade verificada antes de migrar o fallback legado | `docs/plano-de-correcao-2026-09-15.md` seção 1 @90e550d; `docs/plano-de-correcao-2026-09-15.md` seção 2 @90e550d; `docs/implementation_plan.md` seção 4 @90e550d; `docs/data_model.md` seção 2 @90e550d | maranduteam | 15/09/2026 |
...
| D5 | matriz de acesso aprovada (literal na seção 3 do plano de correção) | aprovado-2026-09-15 | uniformizar perfis com dev e admin como exceções explícitas, com `isActive`, `modules`, `isAdmin` e `isOwner` consistentes | `docs/plano-de-correcao-2026-09-15.md` seção 3 @90e550d; `docs/plano-de-correcao-2026-09-15.md` seção 6 @90e550d; `docs/implementation_plan.md` seção 4 @90e550d; `docs/data_model.md` seção 2 @90e550d | maranduteam | 15/09/2026 |
...
| D7 | papel global só via servidor, com fallback de e-mail para UID | aprovado-2026-09-15 | impedir autoatribuição (cliente comum não cria nem altera autorização própria) e migrar identidade com segurança | `docs/plano-de-correcao-2026-09-15.md` seção 1 @90e550d; `docs/implementation_plan.md` seção 4 @90e550d; `docs/data_model.md` seção 2 @90e550d | maranduteam | 15/09/2026 |
| D8 | seed cloud exige `GOOGLE_APPLICATION_CREDENTIALS` sem fallback; CI reprova commit de credenciais | aprovado-2026-09-22 | eliminar fallback implícito para `serviceAccountKey.json` no seed e garantir que chaves de serviço não entrem no repositório no futuro (`.gitignore` + verificação na CI) | `functions/scripts/seed-mock.cjs` modo cloud; `.gitignore` seção 1; `.github/workflows/ci.yml` job `no-secrets` | maranduteam | 22/09/2026 |
