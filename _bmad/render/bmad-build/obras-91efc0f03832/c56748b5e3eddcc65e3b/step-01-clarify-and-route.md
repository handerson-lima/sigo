...
1. Explicit argument
   ...
   - If it points to a file that matches the spec template (has `status` frontmatter with a recognized value: draft, ready-for-dev, in-progress, in-review, or done) → set `spec_file`. Before exiting, run **Story-key resolution** (below). Then **EARLY EXIT** to the appropriate step: `draft` → `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/step-02-plan.md`, `ready-for-dev`/`in-progress` → `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/step-03-implement.md` (or `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/step-oneshot.md` when `route` is `oneshot`), `in-review` → `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/step-04-review.md`. For `done`, ingest as context and proceed to INSTRUCTIONS — do not resume.
...
3. Otherwise — scan artifacts and ask
   - Active specs (`draft`, `ready-for-dev`, `in-progress`, `in-review`) in `/Users/usuario/obras/_bmad-output/implementation-artifacts`? → List them and HALT. Give the user a choice:
     ...
     - **New** — start new work
     If `draft` selected: Set `spec_file`. Run **Story-key resolution** (below). **EARLY EXIT** → `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/step-02-plan.md` (resume planning from the draft)
     If `ready-for-dev` or `in-progress` selected: Set `spec_file`. Run **Story-key resolution** (below). **EARLY EXIT** → `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/step-03-implement.md` (or `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/step-oneshot.md` when `route` is `oneshot`)
     If `in-review` selected: Set `spec_file`. Run **Story-key resolution** (below). **EARLY EXIT** → `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/step-04-review.md`
...
1. Load context.
   ...
   - **Determine context strategy.** Using the intent and the artifact listing, infer whether the current work is a story from an epic. Do not rely on filename patterns or regex — reason about the intent, the listing, and any epics file content together.
     ...
     **A) Epic story path** — if the intent is clearly an epic story:
     ...
     3. **Compile epic context.** Produce `/Users/usuario/obras/_bmad-output/implementation-artifacts/epic-<N>-context.md` by following `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/compile-epic-context.md`, in order of preference:
        - **Preferred — subagent:** spawn a subagent synchronously (wait for it to return in this turn) with `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/compile-epic-context.md` as its prompt. Pass it the epic number, the epics file path, the `/Users/usuario/obras/_bmad-output/planning-artifacts` directory, and the output path `/Users/usuario/obras/_bmad-output/implementation-artifacts/epic-<N>-context.md`.
        - **Fallback — inline** (for runtimes without subagent support, e.g. Copilot, Codex, local Ollama, older Claude): if your runtime cannot spawn subagents, or the spawn fails/times out, read `/Users/usuario/obras/_bmad/render/bmad-build/obras-91efc0f03832/c56748b5e3eddcc65e3b/compile-epic-context.md` yourself and follow its instructions to produce the same output file.
