...
|---|---|
| Calibração de tamanho/pixels/normalização e orçamento de processamento | Antes do build, testar logos reais, qualidade visual e consumo; backend + UX. Alterar conjuntamente validação cliente/servidor e texto “2 MiB” |
